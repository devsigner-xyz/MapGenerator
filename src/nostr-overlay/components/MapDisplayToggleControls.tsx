...
export function MapDisplayToggleControls({
    ...
    return (
        <div className="nostr-map-display-controls" aria-label="Controles de visualizacion del mapa">
            <ToggleGroup
                type="multiple"
                variant="outline"
                size="sm"
            ...
            >
                <ToggleGroupItem className="nostr-map-display-toggle-button" value="cars" aria-label="Alternar coches del mapa" title="Coches">
                ...
                <ToggleGroupItem className="nostr-map-display-toggle-button" value="special-markers" aria-label="Alternar iconos especiales" title="Iconos especiales">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
